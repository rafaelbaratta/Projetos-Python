...
class MainScreen(ctk.CTkFrame):
    ...
    def build(self, pad_x, pad_y):
        ...
        ctk.CTkLabel(self, text="Suas Informações",
        ...
        self.name_entry = ctk.CTkEntry(form_frame, font=(
            "Arial", 18), width=300, height=40, state="disabled")
        self.name_entry.grid(row=0, column=1, sticky='w',
                             pady=pad_y, padx=pad_x)

        ctk.CTkLabel(form_frame, text="E-mail:", font=("Arial", 18)
                     ).grid(row=1, column=0, sticky='e', padx=pad_x)
        self.email_entry = ctk.CTkEntry(form_frame, font=(
            "Arial", 18), width=300, height=40, state="disabled")
        ...
        self.exit_button = ctk.CTkButton(
            button_frame, height=50, width=150, text="Desconectar", font=("Arial", 18))
